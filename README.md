...
## How i achieve it
My goal is to use at most the functional programming approach by writing the code with pure functions, to do that I use higher order functions like map, filter and reduce function instead of for loop for example, I'm using this programming paradigm because it's reduces the likelihood of having bugs or side-effect since it’s not going to mutate variables, I also noticed library like [redux](https://redux.js.org/) use this immutability concept.
